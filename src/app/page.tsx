...
export default async function HomePage() {
  ...
  return (
    <>
        ...
        <div className="grid gap-8 lg:grid-cols-[1.05fr,0.95fr] lg:items-center">
          ...
          <Reveal delay={120}>
            <div className="grid gap-4 lg:grid-cols-[minmax(0,1fr),430px]">
              <div className="relative min-h-[360px] overflow-hidden rounded-[44px] bg-[linear-gradient(145deg,rgba(246,220,228,0.92),rgba(255,249,251,0.84))] shadow-[0_30px_80px_rgba(42,29,24,0.1)] lg:min-h-[520px]">
              ...
              <div className="rounded-[36px] border border-white/70 bg-[rgba(255,251,253,0.86)] p-6 shadow-[0_28px_70px_rgba(42,29,24,0.12)] backdrop-blur-xl">
          ...
          {data.categories.slice(0, 9).map((category, index) => (
            <Reveal key={category.id} delay={index * 40} className={categorySpanClasses[index]}>
              <Link
                ...
                className="group block h-full rounded-[32px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,250,252,0.92),rgba(245,236,239,0.94))] p-6 shadow-[0_18px_40px_rgba(42,29,24,0.06)] transition hover:-translate-y-1.5 hover:shadow-[0_28px_56px_rgba(42,29,24,0.1)]"
              >
                <div
                  className={cn(
                ...
                <h3 className="mt-5 font-display text-3xl tracking-[-0.06em] text-[color:var(--color-ink)]">
                  {category.name}
                </h3>
                <p className="mt-3 max-w-xl text-sm leading-7 text-[color:var(--color-ink-muted)]">
                  {category.description}
                </p>
                <div className="mt-6 inline-flex items-center gap-2 text-sm font-medium text-[color:var(--color-accent-strong)]">
      ...
      <section className="container-shell section-space">
        <Reveal>
          <div className="rounded-[38px] border border-white/70 bg-[linear-gradient(180deg,rgba(255,250,252,0.92),rgba(244,235,239,0.94))] p-6 shadow-[0_28px_66px_rgba(42,29,24,0.08)] lg:p-8">
      ...
      <section className="container-shell section-space">
        <Reveal>
          <div className="rounded-[40px] border border-[rgba(171,83,109,0.16)] bg-[linear-gradient(145deg,rgba(245,223,230,0.94),rgba(255,249,252,0.96))] px-6 py-10 shadow-[0_28px_66px_rgba(42,29,24,0.08)] lg:px-10">
    ...
    <Reveal>
      <section className="container-shell section-space">
        <div className="mb-8 flex items-end justify-between gap-4">
          ...
          <Link href="/browse" className="hidden text-sm font-medium text-[color:var(--color-accent-strong)] lg:inline">
...
function MetricCard({ label, value, detail }: { label: string; value: string; detail: string }) {
  return (
    <div className="rounded-[28px] border border-white/70 bg-[rgba(255,250,252,0.76)] p-5 shadow-[0_18px_40px_rgba(42,29,24,0.06)]">
...
function TrustCard({
  ...
  return (
    <div className="rounded-[28px] border border-white/70 bg-white/66 p-5 shadow-[inset_0_1px_0_rgba(255,255,255,0.74)]">
...
function MiniPanel({
  ...
  return (
    <div
      className={cn(
        "rounded-[24px] p-4 shadow-[inset_0_1px_0_rgba(255,255,255,0.75)]",
        tone === "primary" ? "bg-[rgba(171,83,109,0.12)]" : "bg-[rgba(154,110,134,0.12)]"
      )}
    >
