...
export default function TermsPage() {
  return (
    <PageShell
      ...
      title="Marketplace terms for the Aurelle launch."
        ...
        {[
          {
            ...
            body: "Aurelle provides booking, discovery, trust, moderation, and provider management tooling. Providers remain responsible for the services they deliver and for maintaining accurate business information.",
          },
          {
          ...
          },
          {
            ...
            body: "Aurelle supports only standardized Flexible, Standard, and Strict cancellation policies. Policy terms are shown before checkout and apply to cancellations or no-shows according to the selected provider setting.",
          },
          {
            title: "Provider eligibility",
            body: "Providers do not go live automatically. Aurelle may suspend, decline, or remove providers who fail verification, generate safety concerns, or violate platform standards.",
          },
          {
            title: "Reviews",
          ...
          },
          {
            ...
            body: `Aurelle launches first around ${siteConfig.launchMarket.name}. We may expand to additional schools, neighborhoods, and cities over time, and provider coverage may evolve as each market opens.`,
          },
        ].map((section) => (
